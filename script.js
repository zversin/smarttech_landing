...
const i18n = {
    kz: {
        ...
        text: {
            ...
            heroSubtitle: 'Бизнеске, оқу орындарына және түрлі нысандарға арналған периметрді қорғау жүйелерін жобалап, орнатамыз.',
            heroBtnConsult: 'Нысанды талқылау',
            heroBtnCases: 'Кейстерді көру',
            heroTrust1: 'Астана',
            heroTrust2: 'Монтаж және іске қосу',
            heroTrust3: 'Келісімшарт және сервис',
            ...
            contactTitle: 'Нысанға күзет жүйесін таңдап береміз',
            contactSubtitle: 'WhatsApp немесе Instagram-ға жазыңыз - бейнебақылау, дабыл, турникет пен қолжетімділікті бақылау бойынша бағыт береміз.',
            contactCardTitle: 'Нысанды сипаттаңыз',
            contactCardDesc: 'Қауіпсіздік міндеттеріне, іске қосу мерзіміне және бюджетке сай шешім ұсынамыз.',
    ...
    en: {
        ...
        text: {
            ...
            heroSubtitle: 'We design and install perimeter security systems for businesses, educational facilities, and other sites across Kazakhstan.',
            heroBtnConsult: 'Discuss Your Site',
            heroBtnCases: 'View Cases',
            heroTrust1: 'Astana',
            heroTrust2: 'Installation and commissioning',
            heroTrust3: 'Contract and maintenance',
            ...
            contactTitle: 'We Will Select the Right Security System',
            contactSubtitle: 'Message us on WhatsApp or Instagram for guidance on CCTV, alarms, turnstiles, and access control.',
            contactCardTitle: 'Describe Your Site',
            contactCardDesc: 'We will propose a solution that matches your security goals, launch timeline, and budget.',
